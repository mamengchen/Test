...
class SpeechRec{
    private:
        std::string app_id = "16698518";
        std::string api_key = "sGQF36xBVHnZGo10GX7vc4Xf";
        std::string secret_key = "mcCBTun0gdxnB7QuErUYC8QX6UVHUOM8";
        aip::Speech *client;
    public:
        SpeechRec()
        {
...
class InterRobot{
    private:
        ...
        std::string api_key = "157b8bd84a344fc2b58aed803840a32f";
